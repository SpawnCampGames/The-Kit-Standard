...
public class BasicEditorWindow : BaseEditorWindow
{
    ...
    [MenuItem("SpawnCampGames/Windows/Basic Dockable Window", priority = 2)]
    public static void SpawnWindowFromMenu()
    {
        Texture2D logo = AssetDatabase.LoadAssetAtPath<Texture2D>(
            "Assets/SpawnCampGames/SPWN/Spwn_Graphics/Branding/Spwn_Gamepad.png"
        );
    ...
    [MenuItem("SpawnCampGames/Windows/Basic Utility Window", priority = 2)]
    ...
    {
        var window = CreateInstance<BasicEditorWindow>();
