...
namespace SPWN
{
    ...
    public static class Utils
    {
        ...
        public static void RealtimeDebug(string text, Vector2 position, int fontSize, Color textColor, Color outlineColor, int outlineThickness, int padding)
        {
            ...
            Color backgroundColor = new Color(outlineColor.r, outlineColor.g, outlineColor.b, outlineColor.a * 0.5f);
            DrawBackground(new Rect(adjustedPosition.x, adjustedPosition.y, width, height), backgroundColor);
