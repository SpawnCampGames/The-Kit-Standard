...
public class AboutEditorWindow : BaseEditorWindow
{
    ...
    private const string DocumentationURL = "https://github.com/SpawnCampGames/TheKit/Documentation/";
    ...
    [MenuItem("SpawnCampGames/About/Console Thank You", false, 1)]
    public static void PrintThankYou()
    {
        ...
        string readme = "https://github.com/SpawnCampGames/TheKit/Documentation/";
        Dbug.Green($"📗 The Kit: {readme}");
    }

    [MenuItem("SpawnCampGames/Help/Open Documentation", false, 50)]
